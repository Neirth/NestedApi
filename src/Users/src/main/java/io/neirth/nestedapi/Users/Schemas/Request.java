...
public class Request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4376306381214742279L;
   ...
   */
  public Request(java.lang.Long id, io.neirth.nestedapi.Users.Schemas.UserObj user, java.lang.CharSequence token) {
    this.id = id;
    this.user = user;
    this.token = token;
  }
   ...
   */
  public io.neirth.nestedapi.Users.Schemas.UserObj getUser() {
    return user;
  }
   ...
   */
  public static io.neirth.nestedapi.Users.Schemas.Request.Builder newBuilder() {
    return new io.neirth.nestedapi.Users.Schemas.Request.Builder();
  }
   ...
   * @return A new Request RecordBuilder
   */
  public static io.neirth.nestedapi.Users.Schemas.Request.Builder newBuilder(io.neirth.nestedapi.Users.Schemas.Request.Builder other) {
    if (other == null) {
      return new io.neirth.nestedapi.Users.Schemas.Request.Builder();
    } else {
      return new io.neirth.nestedapi.Users.Schemas.Request.Builder(other);
    }
  }
   ...
   * @return A new Request RecordBuilder
   */
  public static io.neirth.nestedapi.Users.Schemas.Request.Builder newBuilder(io.neirth.nestedapi.Users.Schemas.Request other) {
    if (other == null) {
      return new io.neirth.nestedapi.Users.Schemas.Request.Builder();
    } else {
      return new io.neirth.nestedapi.Users.Schemas.Request.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Request>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.neirth.nestedapi.Users.Schemas.Request.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.neirth.nestedapi.Users.Schemas.Request other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.neirth.nestedapi.Users.Schemas.Request.Builder setId(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.neirth.nestedapi.Users.Schemas.Request.Builder clearId() {
      id = null;
     ...
     * @return This builder.
     */
    public io.neirth.nestedapi.Users.Schemas.UserObj.Builder getUserBuilder() {
      if (userBuilder == null) {
        if (hasUser()) {
          setUserBuilder(io.neirth.nestedapi.Users.Schemas.UserObj.newBuilder(user));
        } else {
          setUserBuilder(io.neirth.nestedapi.Users.Schemas.UserObj.newBuilder());
        }
      }
      return userBuilder;
    }
     ...
     * @return This builder.
     */
    public io.neirth.nestedapi.Users.Schemas.Request.Builder setUserBuilder(io.neirth.nestedapi.Users.Schemas.UserObj.Builder value) {
      clearUser();
      userBuilder = value;
      return this;
    }
